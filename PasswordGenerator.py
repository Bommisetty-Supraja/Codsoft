...
choice=IntVar()
Font=('arial',13,'bold')
passwordLabel=Label(root,text='Password Generator',font=('times new roman',20,'bold'),bg='purple',fg='white')
passwordLabel.grid(pady=10)

MediumradioButton=Radiobutton(root,text='Medium',value=1,variable=choice,font=Font)
...
lengthLabel.grid(pady=5),length_Box.grid()
