...
options = [['Wick van Rossum', 'Rasmus Lerdorf', 'Guido van Rossum', 'Niene Stom', 'Guido van Rossum'],
           ['OOPS', 'structured programming', 'functional programming', ' all of the mentioned', ' all of the mentioned'],
           ['.python', '.pl', ' .py', ' .p', '.py'],
           [' Capitalized', 'lower case', 'UPPER CASE', ' None of the mentioned', ' None of the mentioned'],
           ['Pip Installs Python', 'Pip Installs Packages', 'Preferred Installer Program', 'All of the mentioned', 'Preferred Installer Program']]
